...
public enum RockPaperScissors {
    ...
    public static RockPaperScissors getValueOf(String name) {
        for (RockPaperScissors value : RockPaperScissors.values())
            if (name.toUpperCase().equals(value.name())) return value;
        return null;
    }
    ...
    public static int compare(RockPaperScissors firstValue, RockPaperScissors secondValue) {
        ...
        if (firstValue == ROCK) {
            if (secondValue == ROCK) return 0;
            else if (secondValue == PAPER) return 1;
            else return -1;
        } else if (firstValue == PAPER) {
            if (secondValue == ROCK) return -1;
            else if (secondValue == PAPER) return 0;
            else return 1;
        } else {
            if (secondValue == ROCK) return 1;
            else if (secondValue == PAPER) return -1;
